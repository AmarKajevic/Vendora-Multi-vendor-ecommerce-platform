    ...
    const columns = useMemo(() => [
        {
            ...
            cell: ({row}: any) =>{
                ...
                return (
                <Image
                    src={row.original.images[0]?.url} alt={row.original.images[0]?.url}
                    width={200}
                    height={200}
        ...
        },
        {
            accessorKey: "stock",
            header: "Stock",
            cell: ({row}:any) => <span className={row.original.stock <10 ? "text-red-500" : "text-white"}>
  ...
  return (
    <div className='w-full min-h-screen p-8'>
        <div className='flex justify-between items-center mb-1'>
            ...
            className='bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex justify-between'
            >
                <Plus className='mt-1 mr-2' size={18}/>  Add Product
        ...
        <div className=' flex items-center mb-4'>
            <Link
                href={"/dashboard"} className='text-blue-400 cursor-pointer'
            >
                Dashboard
            </Link>
