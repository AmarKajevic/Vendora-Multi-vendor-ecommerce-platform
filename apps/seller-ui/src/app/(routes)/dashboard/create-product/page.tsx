...
const Page = () => {
  ...
  const handleRemoveImage = async (index: number) => {
    try {
      const updatedImages = [...images];
      const imagesToDelete = updatedImages[index];
      console.log(images[index]);
      if (imagesToDelete && typeof imagesToDelete === "object") {
        await axiosInstance.delete("product/api/delete-product-image", {
          data: { fileId: imagesToDelete.fileId! },
        });
      }
            ...
            <div className="w-2/4">
                ...
                <Input
                  ...
                  {...register("short_description", {
                    ...
                    validate: (value) => {
                      ...
                      return (
                        wordCount <= 150 ||
                        `Description must be less than 150 words (curent: ${wordCount} words)`
                      );
                    },
                  })}
                />
              ...
              <div className="mt-2">
                <Input
                  ...
                  {...register("tags", {
                    required: "Separate related tags with comma",
                  })}
                />
                {errors.tags && (
                  <p className="text-red-500 text-sm mt-1">
              ...
              <div className="mt-2">
                <Input
                  ...
                  {...register("video_url", {
                    pattern: {
                      value:
                        /^https:\/\/(ww\.)?youtube\.com\/embed\/[a-zA-Z0-9_-]+$/,
                      message:
