...
const SignUp = () => {
  ...
  try {
    ...
    // Prikazuje detalje koje server šalje
    console.error("Stripe connection error:", err.response?.data || err.message);
    alert("Stripe error: " + JSON.stringify(err.response?.data || err.message));
  }
};
    return (
            ...
            <div className="md:w-[480px] p-8 bg-white shadow rounded-lg ">
                {activeStep === 1 &&  (
                    <>
                      ...
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <select className="w-full border border-gray-300 outline-0 rounded-[4px] h-10 mb-1"
                        {...register("country", {
                        ...
                        <div className="relative">
                            ...
                            />
                            <button type="button" onClick={() => setPaswordVisible(!passwordVisible)}
                            ...
                            <button 
                            type="submit" 
                            className="w-full cursor-pointer bg-black text-white py-2 rounded-lg mt-4" 
                    ...
                    <div>
                        ...
                        <div className="flex justify-center gap-6 ">
                            {otp?.map((digit, index) => (
                                ...
                                maxLength={1}
                                className="w-12 h-12 text-center border border-gray-300 outline-none rounded-lg"
                                value={digit}
                ...
                {activeStep === 3 && (
                    <div className="text-center ">
                        ...
                        <br/>
                        <button className="w-full m-auto flex items-center justify-center gap-3 text-lg bg-slate-700 text-white py-2 rounded-lg "
