            ...
            <div className="w-full flex p-2 justify-center">
                ...
                {step === "email" && (
                    ...
                    <form onSubmit={handleSubmit(onSubmitEmail)}>
                        ...
                        {errors.email && (
                            ...
                            <button type="submit"
                             className="w-full cursor-pointer bg-black mt-4 text-white py-2 rounded-lg"
                ...
                {step === "reset" && (
                    ...
                    <form onSubmit={handleSubmit(onSubmitPassword)}>
                     <label className="block text-gray-700">NewPassword</label>
                     <input
                        type="password"
                     ...
                     {errors.password && (
                        ...
                        <button
                            type="submit"
                            className="w-full mt-4 text-lg cursor-pointer bg-black text-white rounded-md p-2"
