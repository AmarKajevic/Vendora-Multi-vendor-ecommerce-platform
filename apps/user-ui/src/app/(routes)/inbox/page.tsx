...
const page = () => {
  ...
  const { user} = useRequireAuth() as { user: User | null; isLoading: boolean };
                ...
                chats.map((chat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left text-gray-800 px-4 py-3 transition hover:bg-sky-100 ${
                        isActive ? "bg-sky-200" : ""
                      }`}
                    >
              ...
              <>
                ...
                >
                  ...
                  {messages?.map((msg: any, index: number) => (
                    ...
                    >
                      <div
                        className={`${msg.senderType === "user" ? "bg-sky-600 text-white" : "bg-white text-gray-800"} px-4 py-2 rounded-lg shadow-sm w-fit mt-2`}
                      >
