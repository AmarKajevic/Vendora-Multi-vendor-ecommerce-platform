...
const Page = () => {
  ...
  return (
    <div className="w-full bg-[#f5f5f5] pb-10 rounded-md">
      <div className="w-[90%] lg:w-[80%] mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 ">
          {/* sidebar */}
          <aside className="w-full lg:w-[270px] !rounded bg-white p-4 spave-y-6 shadow-md">
              ...
              <Range
                ...
                renderTrack={({ props, children }) => {
                  ...
                  return (
                    <div
                      {...props}
                      className="h-[6px] bg-sky-300 rounded relative w-full"
                    >
                      {/* aktivni dio */}
                      <div
                ...
                renderThumb={({ props, isDragged }) => {
                  ...
                  return (
                    <div
                      key={key}
                      {...restProps}
                      className={`w-[16px] h-[16px] rounded-full shadow cursor-pointer
                        ${isDragged ? "bg-sky-800 scale-110" : "bg-sky-600"}
                                `}
                    />
                  );
                }}
            ...
            <div className="flex justify-between items-center mt-2 ">
                ...
                <button className="text-sm px-4 py-2 bg-sky-500 hover:bg-sky-800 text-white transition rounded-md"
                    onClick={() => {
            ...
            {totalPages > 1 && (
              <div className="flex justify-center mt-8 gap-2">
                {Array.from({length: totalPages}).map((_,i) => (
                  ...
                  key={i +1}
                  onClick={() => setPage(i + 1)}
                  className={`px-3 py-1 !rounded border border-gray-200 text-sm ${page === i +1 ? "bg-sky-600 text-white" : "bg-white text-black"} `}
                  >
                    {i + 1}
                  </button>
               ) )}
