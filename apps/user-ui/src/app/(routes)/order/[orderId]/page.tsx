...
const page = () => {
  ...
  return (
     <div className='max-w-5xl mx-auto px-4 py-10'>
        <div className="my-4">
            <span
                className='text-gray-800 flex items-center gap-2 font-semibold cursor-pointer'
        ...
        {/* status selector */}
        <div className="mb-6">
            <label className='text-sm font-medium text-gray-800 mr-3'>
            ...
            <select
                ...
                disabled={updating}
                className='border bg-slate-300 text-gray-800 border-gray-800 rounded-md'
            >
                {statuses.map((status)=> {
        ...
        <div>
            ...
            <div className="space-y-4">
                {order.items.map((item:any) => (
                    <div key={item.product.id} className="border border-gray-200 rounded-md p-4 flex items-center gap-4">
                        <Image
                            src={item.product?.images[0]?.url || "https://ik.imagekit.io/amark97/products/product-1783894386740_t5QnF3fq-.jpg?updatedAt=1783894388303"}
                            alt={item.product?.title || "Product image"}
                            width={80}
                            height={80}
                            className='w-16 h-16 object-cover rounded-md morder border-gray-200'
                        />
