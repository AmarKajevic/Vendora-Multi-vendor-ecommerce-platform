...
const Page = () => {
  ...
  const toggleCountries = (label:string) => {
    setSelectedCountries((prev) => prev.includes(label) ? prev.filter((country) => country !== label) : [...prev, label])
  }
      ...
      <div className="w-[90%] lg:w-[80%] mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 ">
          ...
          <aside className="w-full lg:w-[270px] !rounded bg-white p-4 spave-y-6 shadow-md">
            ...
            {/* Countries */}
            <h3 className="text-xl font-Poppins font-medium border-b border-b-slate-200 mt-3">Countries</h3>
            <ul className="space-y-2 !mt-3">
                    ...
                    <li key={country} className="flex items-center justify-between">
                        <label className="flex items-center gap-3 text-sm text-gray-700 cursor-pointer">
                            <input
                                ...
                                onChange={() => toggleCountries(country)}
