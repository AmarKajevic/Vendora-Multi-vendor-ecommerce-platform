...
const SignUp = () => {
    ...
    return (
        <div className="w-full py-10 min-h-[85vh] bg-[#f1f1f1] mt-4">
            ...
            <div className="w-full flex p-2 justify-center">
                <div className="md w-[480px] p-8 bg-white shadow rounded-lg">
                    ...
                    <div className="flex items-center p-2 justify-center gap-3 my-8 text-black text-sm border rounded-md border-gray-300 bg-slate-200">
                        <GoogleButton />
                        <span>Sign in with google</span>
                    </div>


                    <div className="flex items-center justify-center gap-3 my-5 text-gray-400 text-sm">
