            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {wishlist?.map((item: any) => (
                  <tr key={item.id} className="border-b border-b-[#000000e]">
                    ...
                    <td>
                      <div className="flex justify-center items-center border border-gray-200 rounded-[20px] w-[90px] p-[2px]">
                        <button
                          className="text-blac cursor-pointer text-xl"
                    ...
                    <td>
                        <button className="bg-sky-500 cursor-pointer text-white px-5 py-2 rounded-md hover:bg-sky-800 transition-all"
                    ...
                    <td>
                        <button className="bg-red-500 cursor-pointer text-white px-5 py-2 rounded-md hover:bg-red-800 transition-all"
